...
# lesson_classroom_invitations GET    /lessons/:lesson_id/classrooms/:classroom_id/invitations(.:format)                       invitations#index
#                              POST   /lessons/:lesson_id/classrooms/:classroom_id/invitations(.:format)                       invitations#create
#  lesson_classroom_invitation GET    /lessons/:lesson_id/classrooms/:classroom_id/invitations/:id(.:format)                   invitations#show
#                              PATCH  /lessons/:lesson_id/classrooms/:classroom_id/invitations/:id(.:format)                   invitations#update
#                              PUT    /lessons/:lesson_id/classrooms/:classroom_id/invitations/:id(.:format)                   invitations#update
#                              DELETE /lessons/:lesson_id/classrooms/:classroom_id/invitations/:id(.:format)                   invitations#destroy
